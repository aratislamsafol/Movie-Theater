        ...
        <div className="w-full max-w-5xl p-8 bg-stone-800 text-white rounded-xl shadow-lg">
          ...
          <div className="mt-8">
            ...
            <button
              ...
              className={`mt-4 px-4 py-2 text-red-700 border border-red-600 rounded transition hover:text-white hover:bg-red-600 ${
                isEditing ? "hover:bg-blue-50" : "cursor-not-allowed opacity-50"
              }`}
            >
              + Add Email Address
            </button>

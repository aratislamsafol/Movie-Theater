...
const SinglePage = () => {
    ...
    // recomanded movies
    const matchedMovies = combinedData.filter(movie =>
    ...
    return (
        <>
            ...
            >
                <div className="p-4 text-white w-[300px]">
                    <p className="text-sm">You should <Link to="" className="text-red-700">login</Link> to create a playlist.</p>
                </div>
            </Modal>
            ...
            >
                <div className="p-4 text-white w-[300px]">
                     ...
                     <p className="text-sm">You should <Link to="" className="text-red-700">login</Link> to Download this Video </p>
                      {/* using when login  */}
                        {/*<h2 className="text-xl font-semibold">Dowload Quality</h2>
                         ...
                         <div className="flex justify-between items-center py-2 border-b border-gray-600">
                            ...
                            <PiDownloadSimpleLight className="text-red-700 hover:text-red-800 cursor-pointer"/>
                        </div>
                        <div className="flex justify-between items-center py-2 border-b border-gray-600">
                            <div className="">
                                <p className="text-sm">360</p>
            ...
            {/* recommended */}
            <div className="my-2 sm:my-3 md:my-6px-2">
            ...
            <div className="">
                <div className="flex justify-between items-center">
                    <h2 className="text-lg sm:text-lg md:text-xl text-white font-semibold py-2 md:py-4 px-3">Recommended Movies</h2>
                    <Link to="" className="text-red-700 mx-3 font-medium text-xs md:text-sm">View All</Link>
                </div>

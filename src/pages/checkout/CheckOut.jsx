...
const CheckOut = () => {
    ...
    return (
        <form className='p-3 md:p-4 lg:p-5 text-start mb-0 md:mb-20 mt-12'>
            ...
            <div className='text-start p-10 px-6 mt-5 bg-stone-900 rounded-xl'>
                ...
                <p className='font-thin'>You have selected the {memberShip.name} membership level. <br/> Enjoy all the benefits of SuperIT</p>
            ...
            <button className='bg-red-700 text-white px-3 py-2 text-sm md:text-base md:px-4 md:py-3 mt-6 rounded'>Submit and Checkout</button>
        </form>
    );
};

...
const Login = () => {
    return (
      <div className="bg-[url(src/assets/images/authbg.webp)] overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 h-full items-center justify-center flex text-white ">
        <div className="relative p-4 w-full max-w-md h-full md:h-auto bg-black/80 rounded-lg shadow">
                <div className="p-5">
                    ...
                    <form className="w-full">
                        ...
                        <button type="submit"
                            className="inline-flex w-full items-center justify-center rounded-lg bg-red-700 p-2 py-3 text-sm font-medium text-white outline-none focus:ring-2 focus:ring-black focus:ring-offset-1 disabled:bg-gray-400 cursor-pointer">
                            Continue
                        </button>
                    </form>
                    ...
                    <div className="mt-6 text-center text-sm text-slate-600">
                        ...
                        <a href="/signup" className="font-medium text-red-700"> Sign up</a>
                    </div>
                </div>
        </div>
        </div>
